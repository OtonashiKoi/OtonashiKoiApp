...
(async function main() {
  try {
    const tplPath = require('path').resolve(__dirname, './npc-templates/forest-girl-attacked.json');
    ...
    try {
      ...
      // prefer shield/offhand slots for the save option
      const preferredSlots = ['offhand','shield'];
