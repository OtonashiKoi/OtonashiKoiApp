...
const ALL_JOBS = [
  ...
  ["二轉 盜靈",       "job_spiritthief_t2_v1",  "dagger",   "agi", { _dualDagger: true }],
  ["二轉 元素師(炎圈)", "job_elementalist_t2_v1", "staff_2h", "int", { stance: "fire" }],
  ["二轉 元素師(嵐暴)", "job_elementalist_t2_v1", "staff_2h", "int", { stance: "storm" }],
  ["二轉 元素師(凍霜)", "job_elementalist_t2_v1", "staff_2h", "int", { stance: "frost" }],
