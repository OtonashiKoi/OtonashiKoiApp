...
- 新版介面的玩家可見頁面不再顯示「測試版」、「NEW UI PREVIEW」或「封閉測試」標籤。自 2026-08-13 正式開放後，所有玩家預設使用第三版「紫藤冒險據點」，設定頁保留第三版、第二版及舊版「暗黑奇幻」切換；玩家主動切換後會在該裝置持續保留選擇。
