...
> ⛔ **歷史索引（2026-08-07 審計標記）**：本檔最後更新 2026-05-30，之後的系統
>（主線劇情、直播記錄層、全服 Buff/SC 條、職業二轉、單人世界王、KDA、屬性系統、附魔/鍛造、
> 商品兌換/金流）全數未收錄，且檔內行數/行號多已漂移（如 enhance API 現在 `playerAppRoutes.js:5261`）。
> **現役系統索引請改看 [SYSTEMS.md](SYSTEMS.md)**，本檔僅存檔備查。
