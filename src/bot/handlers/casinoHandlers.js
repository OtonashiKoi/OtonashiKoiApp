...
async function handleRules(interaction) {
  const lines = [
    ...
    "",
    `**押注**：${BET_MIN.toLocaleString("zh-TW")}–${BET_MAX.toLocaleString("zh-TW")} 金幣，單注賠付上限 ${PAYOUT_CAP.toLocaleString("zh-TW")}。`,
    "**押中後額外抽道具**（依下注額解鎖）：",
    "・100–5,000：8%，僅 D 階",
    "・5,001–30,000：12%，至 C 階",
    "・30,001–100,000：15%，至 B 階",
    "・100,001–500,000：20%，**A 階全解鎖**（裝備 / 卡片 / 強化石）",
    "",
