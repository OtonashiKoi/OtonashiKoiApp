...
const STAT_EFFECT_MAP = {
  ...
  str_up: { stat: "str", mode: "add", amount: 3 },
  str_down: { stat: "str", mode: "add", amount: -3 },
  agi_up: { stat: "agi", mode: "add", amount: 3 },
  agi_down: { stat: "agi", mode: "add", amount: -3 },
  vit_up: { stat: "vit", mode: "add", amount: 3 },
  vit_down: { stat: "vit", mode: "add", amount: -3 },
  int_up: { stat: "int", mode: "add", amount: 3 },
  int_down: { stat: "int", mode: "add", amount: -3 },
  dex_up: { stat: "dex", mode: "add", amount: 3 },
  dex_down: { stat: "dex", mode: "add", amount: -3 },
  luk_up: { stat: "luk", mode: "add", amount: 3 },
  luk_down: { stat: "luk", mode: "add", amount: -3 },
