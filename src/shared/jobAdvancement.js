  ...
  rogue: [
    {
      ...
      battleActions: [
        { slot: 1, key: "attack",      label: "攻擊", icon: "⚔️", tone: "gold",    kind: "normal" },
        // 影襲：消耗 5 點區域連段（COMBO）→ 第一回合固定 7 連擊（會累氣）
        { slot: 2, key: "shadow_rush", label: "影襲", icon: "🌀", tone: "crimson", kind: "shadow_rush", requiresCombo: 5 },
      ],
    ...
    },
    {
      ...
      //    實測（1500~2000場/組・古龍王頭部・對照＝影舞者＋影襲的真實玩法）：
  ...
  mage: [
    {
      ...
      stances: {
        ...
        storm: {
          ...
          stormVolley: { hits: 3, pctPerHit: 85 },
        },
        frost: {
          label: "凍霜",
