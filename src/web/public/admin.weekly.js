...
(function () {
  const QUEST_TYPE_LABELS = {
    ...
    // 二轉試煉：以某一轉職業出戰的次數
    battle_as_swordsman: "以劍士出戰次數",
    battle_as_warrior: "以戰士出戰次數",
    battle_as_dwarf_warrior: "以矮人戰士出戰次數",
    battle_as_rogue: "以盜賊出戰次數",
    battle_as_mage: "以法師出戰次數",
    battle_as_healer: "以治療師出戰次數",
    battle_as_archer: "以弓箭手出戰次數",
    battle_as_tactician: "以軍師出戰次數",
    battle_as_bard: "以詩人出戰次數",
    battle_as_barrier_mage: "以結界師出戰次數",
    battle_as_gambler: "以賭徒出戰次數",
    battle_win:    "戰鬥勝利次數",
    damage_total:  "累計造成傷害",
  ...
  const QUEST_TYPE_UNITS = {
    ...
    battle_with_bow: "次",
    battle_with_dice: "次",
    battle_as_swordsman: "次",
    battle_as_warrior: "次",
    battle_as_dwarf_warrior: "次",
    battle_as_rogue: "次",
    battle_as_mage: "次",
    battle_as_healer: "次",
    battle_as_archer: "次",
    battle_as_tactician: "次",
    battle_as_bard: "次",
    battle_as_barrier_mage: "次",
    battle_as_gambler: "次",
    battle_win:    "次",
    damage_total:  "點",
